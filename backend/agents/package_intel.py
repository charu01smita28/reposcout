...
def search_packages(query: str, limit: int = 20) -> dict:
    ...
    # Multi-source merge: growth → semantic → keyword (deduplicated)
    # Growth queries: growth results first, then semantic
    # Normal queries: semantic first, then keyword
    ...  # merge and dedup logic removed for public repository
